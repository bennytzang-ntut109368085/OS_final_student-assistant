...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void checkMode() {
        Intent i = getIntent();
        mode = i.getIntExtra("mode", Main_Timetable.REQUEST_ADD);

        if (mode == Main_Timetable.REQUEST_EDIT) {
            loadScheduleData();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.submit_btn:
                if (mode == Main_Timetable.REQUEST_ADD) {
                    inputDataProcessing();
                    Intent i = new Intent();
                    ...
                    finish();
                } else if (mode == Main_Timetable.REQUEST_EDIT) {
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
